...
#if defined(__IPHONE_OS_VERSION_MIN_REQUIRED)
static NSString * const reviewURLTemplate                   = @"itms-apps://itunes.apple.com/app/idAPP_ID";
#else
...
#if defined(__IPHONE_OS_VERSION_MIN_REQUIRED)
    //Use the in-app StoreKit view if set. This works in the simulator.
    if (self.opensInStoreKit) {
